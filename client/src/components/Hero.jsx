          ...
          <div className="row align-items-center">
            ...
            <div className="col-12 col-lg-6 ms-lg-auto">
              <div className="w-xl-12/10 position-relative">
                ...
                <img alt="..." src="https://images.unsplash.com/photo-1543269664-76bc3997d9ea?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1000&h=900&q=80" class="shadow-4 rounded-4 position-relative overlap-05" />
              </div>
            </div>
          </div>
        </div>
